...
class GuildsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guild" do
    assert_difference('Guild.count') do
      post guilds_url, params: { guild: { alliance_id: @guild.alliance_id, api_id: @guild.api_id, name: @guild.name } }
    end
  ...
  test "should update guild" do
    patch guild_url(@guild), params: { guild: { alliance_id: @guild.alliance_id, api_id: @guild.api_id, name: @guild.name } }
